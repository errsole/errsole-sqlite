...
class ErrsoleSQLite extends EventEmitter {
  ...
  async createTables () {
    const queries = [
      ...
      'CREATE INDEX IF NOT EXISTS idx_errsole_logs_v1_source_level_id ON errsole_logs_v1 (source, level, id)',
      'CREATE INDEX IF NOT EXISTS idx_errsole_logs_v1_source_level_timestamp ON errsole_logs_v1 (source, level, timestamp)',
      'CREATE INDEX IF NOT EXISTS idx_errsole_logs_v1_hostname_pid_id ON errsole_logs_v1 (hostname, pid, id)'
    ];
