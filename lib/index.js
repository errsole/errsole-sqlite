...
class ErrsoleSQLite extends EventEmitter {
  ...
  async createTables () {
    const queries = [
        ...
        `CREATE INDEX IF NOT EXISTS idx_${this.logsTable}_hostname_source_level_id ON ${this.logsTable} (hostname, source, level, id)`,
        `CREATE INDEX IF NOT EXISTS idx_${this.logsTable}_hostname_id ON ${this.logsTable} (hostname, id)`,
